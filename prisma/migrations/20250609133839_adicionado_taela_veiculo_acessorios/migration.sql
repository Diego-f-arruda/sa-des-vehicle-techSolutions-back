-- CreateEnum
CREATE TYPE "TipoAcessorio" AS ENUM ('PECA', 'ACABAMENTO', 'KIT_RODA', 'ACESSORIO');
...
CREATE TABLE "veiculos_acessorios" (
    ...
    CONSTRAINT "veiculos_acessorios_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "veiculos_acessorios_veiculoId_produtoId_key" ON "veiculos_acessorios"("veiculoId", "produtoId");
...
-- AddForeignKey
ALTER TABLE "veiculos_acessorios" ADD CONSTRAINT "veiculos_acessorios_veiculoId_fkey" FOREIGN KEY ("veiculoId") REFERENCES "veiculos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "veiculos_acessorios" ADD CONSTRAINT "veiculos_acessorios_produtoId_fkey" FOREIGN KEY ("produtoId") REFERENCES "produto"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
